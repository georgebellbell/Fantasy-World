...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
	...
	light = new Light(heightmapSize * Vector3(0.5f, 1.5f, 0.5f), Vector4(1, 1, 1, 1), heightmapSize.x * 0.5f, Vector4(1, 1, 0, 1));
...
void Renderer::RenderScene() {
	...
	glUniform1i(glGetUniformLocation(shader->GetProgram(), "bumpTex"), 0);
